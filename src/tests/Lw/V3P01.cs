...
namespace task4
{
    class Sorter : IDisposable
    {
        ...
        // если не все потоки завершились, то придется создать дополнительтную структуру данных, где хранить те части, которые были объединены
        // попробовать переиспользовать основной массив или создать дополнительный массив
        private int[] Merge()
        {
