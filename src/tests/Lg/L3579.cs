...
namespace Water
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Thread H7 = new Thread(() => h2o.Hydrogen(printHydro));
            Thread H8 = new Thread(() => h2o.Hydrogen(printHydro));
            Thread H9 = new Thread(() => h2o.Hydrogen(printHydro));


            Thread O1 = new Thread(() => h2o.Oxygen(printOxy));
            Thread O2 = new Thread(() => h2o.Oxygen(printOxy));
            Thread O3 = new Thread(() => h2o.Oxygen(printOxy));
            Thread O4 = new Thread(() => h2o.Oxygen(printOxy));
